...
BEGIN
    ...
    PLOG_INTERFACE.log(pCTX, pID, pLDate, pLHSECS, pLLEVEL, pLSECTION, pLUSER, LLTEXT, pLPARAMETERS, pLSQLTEXT);
...
FUNCTION isCrucInfoEnabled
RETURN BOOLEAN
--******************************************************************************
--   NAME:   isCrucInfoEnabled
--
--   Public. Test if a 'CrucInfo' log level is enabled or not for the default log context.
--   Returned values:
--   TRUE: 'CrucInfo' log level is enabled
--   FALSE: 'CrucInfo' log level is disabled
--
--   Ver    Date        Autor             Comment
--   -----  ----------  ---------------   --------------------------------------
--   1.0    17.04.2008  Bertrand Caradec  Initial version
...
IS
BEGIN
	RETURN isLevelEnabled(PLOGPARAM.getTextInLevel('CrucInfo'));
END isCrucInfoEnabled;
...
FUNCTION isCrucInfoEnabled (pCTX IN PLOGPARAM.LOG_CTX)
RETURN BOOLEAN
--******************************************************************************
--   NAME:   isCrucInfoEnabled
--
...
IS
BEGIN
  RETURN isLevelEnabled(pCTX, PLOGPARAM.getTextInLevel('CrucInfo'));
END isCrucInfoEnabled;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel(pLEVEL), pCTX => pCTX, pTEXT => pTEXT,pLPARAMETERS => pLPARAMETERS ,pLSQLTEXT => pLSQLTEXT);
END log;
...
IS
   generiqueCTX PLOGPARAM.LOG_CTX := getDefaultContext;
BEGIN
    LOG(pLEVEL => pLEVEL, pCTX => generiqueCTX, pTEXT => pTEXT,pLPARAMETERS => pLPARAMETERS,pLSQLTEXT => pLSQLTEXT);
END log;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel(pLEVEL), pTEXT => pTEXT ,pLPARAMETERS => pLPARAMETERS,pLSQLTEXT => pLSQLTEXT);
END log;
...
IS
   ...
   vLPARAMETERS TLOG.LPARAMETERS%TYPE := '';
   vLSQLTEXT    TLOG.LSQLTEXT%TYPE;
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('DEBUG'), pCTX => pCTX, pTEXT => pTEXT, pLPARAMETERS => vLPARAMETERS, pLSQLTEXT => vLSQLTEXT);
END debug;
...
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('DEBUG'), pTEXT => pTEXT,pLPARAMETERS => pLPARAMETERS,pLSQLTEXT => pLSQLTEXT);
END debug;
...
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('INFO'), pCTX => pCTX,  pTEXT => pTEXT,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END info;
...
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('INFO'),  pTEXT => pTEXT,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END info;
...
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('INFO'),  pTEXT => pTEXT,pLPARAMETERS => pLPARAMETERS,pLSQLTEXT => pLSQLTEXT);
END info;
...
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('WARN'), pCTX => pCTX,  pTEXT => pTEXT,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END warn;
...
BEGIN
    LOG(pLEVEL => PLOGPARAM.getTextInLevel('WARN'),  pTEXT => pTEXT,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END warn;
...
BEGIN
    LOG(pLEVEL => PLOGPARAM.getTextInLevel('WARN'),  pTEXT => pTEXT,pLPARAMETERS => pLPARAMETERS,pLSQLTEXT => pLSQLTEXT);
END warn;
...
IS
   ...
   vLSQLTEXT    TLOG.LSQLTEXT%TYPE;
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('ERROR'), pCTX => pCTX,  pTEXT => pTEXT,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END error;
...
--******************************************************************************
BEGIN
    LOG(pLEVEL => PLOGPARAM.getTextInLevel('ERROR'),  pTEXT => pTEXT,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END error;
...
BEGIN
    LOG(pLEVEL => PLOGPARAM.getTextInLevel('ERROR'),  pTEXT => pTEXT,pLPARAMETERS => pLPARAMETERS,pLSQLTEXT => pLSQLTEXT);
END error;
...
IS
   ...
   vLSQLTEXT    TLOG.LSQLTEXT%TYPE;
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('CrucInfo'), pCTX => pCTX,  pTEXT => pTEXT,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END CrucInfo;
...
BEGIN
    LOG(pLEVEL => PLOGPARAM.getTextInLevel('CrucInfo'),  pTEXT => pTEXT,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END CrucInfo;
...
--   Public. Log a message of error level using the default log context.
--   The parameter pTEXT is the message text. If the parameter is NULL, the
--   parameter pLPARAMETERS is procedure's parameters,the parameter pLSQLTEXT
--	 is the SQL code
--
--   Ver    Date        Autor             Comment
--   -----  ----------  ---------------   --------------------------------------
--   1.0    17.12.2012  Jijun Ren				  Initial version
--******************************************************************************
  
BEGIN
    LOG(pLEVEL => PLOGPARAM.getTextInLevel('CrucInfo'),  pTEXT => pTEXT,pLPARAMETERS => pLPARAMETERS,pLSQLTEXT => pLSQLTEXT);
END CrucInfo;
...
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('FATAL'), pCTX => pCTX,  pTEXT => pTEXT,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END fatal;
...
IS
   ...
   vLSQLTEXT    TLOG.LSQLTEXT%TYPE;
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('FATAL'),  pTEXT => pTEXT,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END fatal;
...
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('FATAL'),  pTEXT => pTEXT,pLPARAMETERS => pLPARAMETERS,pLSQLTEXT => pLSQLTEXT);
END fatal;
...
BEGIN
  ...
  IF NOT pCONDITION THEN
     LOG (pLEVEL => PLOGPARAM.DEFAULT_ASSET_LEVEL, pCTX => pCTX,  pTEXT => 'AAS'||pLogErrorCodeIfFALSE||': '||pLogErrorMessageIfFALSE,pLPARAMETERS => pLPARAMETERS,pLSQLTEXT => pLSQLTEXT);
...
BEGIN
     checkAndInitCTX(pCTX);
     log(pLEVEL => PLOGPARAM.DEFAULT_FULL_CALL_STACK_LEVEL, pCTX => pCTX,  pTEXT => dbms_utility.format_call_stack,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT );
END full_call_stack;
...
BEGIN
     ...
     log(pLEVEL => PLOGPARAM.DEFAULT_FT_ERR_BTRACE_LEVEL, pCTX => pCTX,  pTEXT => LLTEXT ,pLPARAMETERS => vLPARAMETERS,pLSQLTEXT => vLSQLTEXT);
END full_error_backtrace;
