-------------------------------------------------------------------------
-- CodeUpgrade.sql (sqlplus script)
-- The script is use to update your schema objects.
-- Upgrade schema objects includes:temporary tables,function,view,materialized view,procedure,package
...
--      check the CodeUpgrade.log in the current directory 
-------------------------------------------------------------------------


spool CodeUpgrade.log
set termout on; --close the result of the command
set serveroutput on;-- print the dbms_output value
