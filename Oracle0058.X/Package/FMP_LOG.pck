...
CREATE OR REPLACE PACKAGE BODY FMP_LOG IS
  ...
  BEGIN
    ...
    begin
      nIndexBegin := instr(pIn_vLine, c_cEndOfField, -1, 5);
      nIndexEnd   := instr(pIn_vLine, c_cEndOfField, -1, 4);
      if nIndexEnd = 0 then
