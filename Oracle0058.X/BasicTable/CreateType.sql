...
/
create or replace type FMT_obj_nodeid is object
(
  id number
);
/
...
/
create or replace type FMT_NodeAttriValue is object (NodeID number, AttriValueID number);
/
...
/
create or replace type FMT_NODETS as object
(
