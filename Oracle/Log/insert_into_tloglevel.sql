...
delete from TLOGLEVEL t where t.LLEVEL in (10,20,29,30,40,50,60,70);
commit;
...
insert into TLOGLEVEL (LLEVEL, LJLEVEL,  LCODE , LDESC) Values 
(29,41000,'CrucInfo', 'The Crucial INFO shows the progress of the application which  may make an very important  modification to the main datas.');
