...
rem set/p impdbauser=Please input  database sys username¡¾press enter is default value:%impdbauser%¡¿:
rem set/p impdbapassword=Please input  database sys user of password¡¾press enter is default value:%impdbapassword%¡¿:
set/p fmuser=Please input  database username¡¾press enter is default value:%fmuser%¡¿:
set/p fmuserpassword=Please input  database user password¡¾press enter is default value:%fmuserpassword%¡¿:
set/p target_service_name=Please input database of service name¡¾press enter is default value:%target_service_name%¡¿:
rem set/p target_service_name_db=Please input database connect¡¾press enter is default value:%target_service_name_db%¡¿:
)
...
rem rem echo  grant connect,resource to %fmuser%;>>.\grant.sql
rem rem echo  grant create view to %fmuser%;>>.\grant.sql
rem rem echo  grant create procedure to %fmuser%;>>.\grant.sql
rem rem echo  grant create materialized view to %fmuser%;>>.\grant.sql
...
rem rem echo  grant debug connect session to %fmuser%;>>.\grant.sql
...
sqlplus %fmuser%/%fmuserpassword%@%target_service_name% @.\FMOracleServer_InitDB.sql
